...
export default class APICaller extends Vue {
    ...
    constructor() {
        ...
        // tslint:disable-next-line:max-line-length
        this.eventsLink = 'https://www.googleapis.com/storage/v1/b/fb-events2/o?prefix=events/v6/' + dayToFetchFrom.format('YYYYMMDD') + '&fbclid=IwAR13SDH31uFm3hBeiR7i9pjF3ePV3VUB1qw1X5btoG03YKLIZWkwqnbzq34';
        this.events = [];
    }
